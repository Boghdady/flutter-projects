          ...
          Row(
            children: <Widget>[
              IconButton(
                ...
                onPressed: () {
                  if (favouritsIds.contains(postion)) {
                    favouritsIds.remove(postion);
                  } else {
                    favouritsIds.add(postion);
                  }
                  setState(() {});
                  print(favouritsIds);
                },
                color:
                    (favouritsIds.contains(postion) ? Colors.red : Colors.grey),
                iconSize: 24,
              ),
              Transform.translate(
                offset: Offset(-8, 0),
