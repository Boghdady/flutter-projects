                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: facebook_grey_color, shape: BoxShape.circle),
                      ),
                    ),
                    Expanded(
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: facebook_dgrey_color, width: 1)),
                          child: Padding(
            ...
            child: Container(
              ...
              child: FutureBuilder(
                  future: DefaultAssetBundle.of(context)
                      .loadString('assets/json/FacebookPost.json'),
